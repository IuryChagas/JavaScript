...
result(`'Grandes poderes trazem grandes responsabilidades.'`)
...
const jsV2 = programmingLanguage[0] + programmingLanguage[4]
...
const findOccurrenceOfMDN = mozilla[mozilla.lastIndexOf('M')] + mozilla[mozilla.lastIndexOf('D')] + mozilla[mozilla.lastIndexOf('N')]
const mdn = findOccurrenceOfMDN
const mdnV2 = mozilla[0] + mozilla[8] + mozilla[mozilla.length - 7]
...
result('length of word --> "JavaScript": '+ programmingLanguage.length +" characters")
...
result("last character of randomWord: "+ randomWord[randomWord.length -1])
...
result(summerMessage.toLocaleLowerCase())

/*
8 - Comente o console.log acima, e,
...
result(winterMessage.toUpperCase())

/*
9 - Comente o console.log acima, e,

- Exiba, no console, o index do caractere "v" da "winterMessage";
*/
section(9)

const getIndexOfV = winterMessage.indexOf('v')
result(getIndexOfV)
...
const getLastIndexOfN = winterMessage.lastIndexOf('n') 

result("getLastIndexOfN: "+ getLastIndexOfN)
...
const getJKOf = harryPotterAuthor.slice(0,5)
result(getJKOf)
...
/*
19 - Comente o console.log acima (e a const bookMessage caso não tenha descoberto a resolução), e,
